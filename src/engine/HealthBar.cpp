...
HealthBar::HealthBar(string id) : DisplayObjectContainer(id, "") {
    ...
    DisplayObjectContainer* heart1 = new DisplayObjectContainer("heart1", "./resources/scenes/UI_DEMO/full_heart.png");
    DisplayObjectContainer* heart2 = new DisplayObjectContainer("heart2", "./resources/scenes/UI_DEMO/full_heart.png");
    DisplayObjectContainer* heart3 = new DisplayObjectContainer("heart1", "./resources/scenes/UI_DEMO/full_heart.png");
